...
public class MainActivityTablet extends MainActivity implements OnTabSelectedListener
{
    ...
    //            case POS_MAIN:
    //
    //                mNavigationComposite.showPrimaryFragment(new HomeFragmentTablet(), MENUS_TITLE[POS_MAIN]);
    //
    ...
    //            case POS_SETTINGS:
    //
    //                mNavigationComposite.showPrimaryFragment(new SettingsFragmentTablet(), MENUS_TITLE[POS_SETTINGS]);
    //
    //                setEditButtonVisibility(false);
    //
    //                break;
